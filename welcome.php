...
class Welcome extends CI_Controller {
    ...
    public function index() // หน้าแรกเริ่มต้นของโปรแกรม
	{
        ...
        public   function  log_login() #log file รายละเอียดสำหรับการ login
        {
            ...
            echo $sess_username=$this->session->userdata('sess_username'); //ตัวอย่างวิธีเรียกใช้
            echo  "<br>";
            echo  $sess_lastname=$this->session->userdata('sess_lastname');
            echo  "<br>";
            echo  $sess_usertype=$this->session->userdata('sess_usertype');
            echo  "<br>";
